...
class CommonPassionScreen extends StatefulWidget {
  const CommonPassionScreen({Key? key}) : super(key: key);

  @override
  _CommonPassionScreenState createState() => _CommonPassionScreenState();
}

class _CommonPassionScreenState extends State<CommonPassionScreen> {
  ...
  void _getUserInfo() async {
    ...
    if (prefs.containsKey(sCommonInterestUser)) {
      var _users = prefs.getString(sCommonInterestUser);
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const PreferredSize(
        ...
        child: DiscoverAppBar(headerName: 'Common Passion'),
      ),
      body: SafeArea(
        child: Padding(

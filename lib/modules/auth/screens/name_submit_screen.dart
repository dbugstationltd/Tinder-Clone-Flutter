...
class NameSubmitScreen extends StatefulWidget {
  @override
  _NameSubmitScreenState createState() => _NameSubmitScreenState();
}

class _NameSubmitScreenState extends State<NameSubmitScreen> {
  String name = '';
            ...
            child: GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "This is how it will appear in Ashiqui, and\nyou will not be able to change it.",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: kHintTextColor,
                      fontSize: 15.0,
  ...
  void _handleContinueBtn() async {
    if (name != "") {
      ...
      try {
        ...
        Response response = await CallApi().postData(data, nameSubmitRoute);
      ...
      ToastMaker().simpleErrorToast("Please enter your name");
    }
  }
}
